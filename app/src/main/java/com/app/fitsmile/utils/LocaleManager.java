...
public class LocaleManager {
    ...
    public @interface LocaleDef {
        String[] SUPPORTED_LOCALES = {ENGLISH,SPANISH};
    }
...
//        updateLanguageResources(mContext, SPANISH);
    ...
    public static Context setNewLocale(Context mContext, @LocaleDef String language) {
        ...
        //return updateResources(mContext, language);
         updateLanguageResources(mContext,language);
         return mContext;
    }

    public static boolean updateLanguageResources(Context context, String language) {
