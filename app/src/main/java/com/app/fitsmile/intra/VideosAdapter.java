...
public class VideosAdapter extends BaseAdapter implements CompoundButton.OnCheckedChangeListener {
	...
	public SparseBooleanArray mVideoCheckStates;
	boolean changeStatus;

	public VideosAdapter(PlaybackActivity activity, List<String> list, GridView mGridView, boolean changeStatus) {
		this.activity = activity;
		this.list = list;
		this.changeStatus = changeStatus;
		this.mGridView = mGridView;
		mInflater = LayoutInflater.from(activity);
		mVideoCheckStates = new SparseBooleanArray(list.size());
	}
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.mTextViewDate = (TextView) convertView.findViewById(R.id.tv_Videos_Date);
		...
		//viewHolder.checkBox.setChecked(mVideoCheckStates.get(position, false));
	...
	public boolean isChecked(int position) {
		return mVideoCheckStates.get(position, false);
	}

	public void setChecked(int position, boolean isChecked) {
		mVideoCheckStates.put(position, isChecked);
	...
	public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
		mVideoCheckStates.put((Integer) buttonView.getTag(), isChecked);
	}
	...
	public void viewCheckBox(ViewHolder viewHolder) {
		viewHolder.checkBox.setChecked(false);
	}
